    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string UserName="", string Password="")
        {
            ...
            using (DAPPER_DATA_SERVICE dapper = new DAPPER_DATA_SERVICE())
            {
                ...
                //UserName = "Zeesshan";
                //Password = "123";
                dapper.AddUnicodeStringParameter("UserName", UserName, 50);
                dapper.AddUnicodeStringParameter("Password", Password, 40);

                var result = dapper.query_multiple("dbo.UserAuth");
                if (result.hasRows())
                {
                    model.LoginList = result.Read<LoginModel>().ToList();
                    model.SetModel();
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Login(LoginModel model, string returnUrl="/Home/Dashboard")
        {
        ...
        public ActionResult LogOff()
        {
            ...
            return RedirectToAction("Login", "Assets");
        }
